      ...
      mappy_tag.once('mappy').each(function (index) {
        ...
        mappy[index] = {
          ...
          width: mappy_instance.get(0)
            ...
            .getAttribute("width") : Drupal.settings.mappy_google_width,
          ...
          height: mappy_instance.get(0)
            ...
            .getAttribute("height") : Drupal.settings.mappy_google_height,
          // Scale of the map.
          zoom: mappy_instance.get(0)
            .getAttribute("zoom") > 0 ? parseInt(mappy_instance.get(0)
            .getAttribute("zoom")) : 17,
          // The map type.
          type: mappy_instance.get(0)
            .getAttribute("type") ? mappy_instance.get(0)
            .getAttribute("type") : "ROADMAP",
          // If TRUE: display zoom control.
          zoomControl: mappy_instance.get(0)
            .getAttribute("zoomControl") == "false" ? false : true,
          // If TRUE: allow users to use street view.
          streetViewControl: mappy_instance.get(0)
            .getAttribute("streetViewControl") == "false" ? false : true,
          // If TRUE: allow users to select map layer.
          mapTypeControl: mappy_instance.get(0)
            .getAttribute("mapTypeControl") == "false" ? false : true,
          // If TRUE: display circle for move the map.
          panControl: mappy_instance.get(0)
            .getAttribute("panControl") == "false" ? false : true,
          ...
          scrollWheel: mappy_instance.get(0)
            .getAttribute("scrollwheel") == "false" ? false : true,
          ...
          // Additional options.
          additionalOptions: mappy_instance.get(0)
            .getAttribute("options") ? eval("(" + mappy_instance.get(0)
              .getAttribute("options") + ")") : false
        };
